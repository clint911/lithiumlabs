        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-block p-6 sm:p-8 md:p-12 lg:p-16 rounded-[4rem] backdrop-blur-3xl bg-white/[0.06] border border-white/10 mb-12 shadow-4xl animate-in fade-in zoom-in duration-1000">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/70 max-w-4xl mx-auto leading-relaxed font-light">
              Lithium Labs serves as the foundational partner for modern
              financial technology. We build the infrastructure that moves the
              world’s money, empowering businesses to navigate the digital
              economy through engineering secure, compliant, or scalable
              products.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <Card className="backdrop-blur-2xl bg-white/[0.05] border-white/10 rounded-[3.5rem] group shadow-[0_0_40px_rgba(37,99,235,0.03)] hover:shadow-[0_0_60px_rgba(37,99,235,0.08)]">
              <CardContent className="p-12 md:p-16">
                ...
                <p className="text-xl text-white/70 mb-10 leading-relaxed font-light">
                  To deliver high-impact financial systems that drive business
                  value from Day 0 by building reliable, secure, and scalable
                  technology that solves both business problems and creates user
                  experiences we are proud of.
                </p>
            ...
            <Card className="backdrop-blur-2xl bg-white/[0.05] border-white/10 rounded-[3.5rem] group shadow-[0_0_40px_rgba(255,100,255,0.02)] hover:shadow-[0_0_60px_rgba(255,100,255,0.05)]">
              <CardContent className="p-12 md:p-16">
                ...
                <p className="text-xl text-white/70 mb-10 leading-relaxed font-light">
                  To establish a new standard for excellence across all domains
                  of software development - from traditional web applications to
                  cutting-edge FinTech and blockchain solutions.
                </p>
            ...
            {[
              {
                ...
                color: "brand-primary",
                description:
                  "Robust protocols and stringent compliance in every solution.",
              },
              {
                ...
                description:
                  "Focus on tangible business outcomes and measurable ROI.",
              },
              {
                ...
                description:
                  "Technical and strategic expertise under one trusted partnership.",
              },
              {
                ...
                color: "brand-primary",
                description:
                  "Forefront of emerging technologies in FinTech and Web3.",
              },
            ].map((value, index) => (
              <Card
                key={index}
              ...
              >
                <CardContent className="p-12">
                  <div
                    className={`text-${value.color} mb-8 flex justify-center transition-transform duration-500 group-hover:scale-110`}
                  >
                    {value.icon}
                  </div>
                  ...
                  <p className="text-white/60 text-xs leading-relaxed font-light uppercase tracking-widest leading-loose">
                    {value.description}
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="backdrop-blur-3xl bg-white/[0.03] border border-white/10 rounded-[4rem] p-8 sm:p-12 md:p-16 lg:p-24 shadow-4xl relative overflow-hidden">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 sm:mb-12 max-w-2xl mx-auto font-light leading-relaxed">
              Ready to transform your innovative concept into a market-ready
              digital product?
            </p>
            <Link href="/contact">
              <Button
