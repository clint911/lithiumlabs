        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-block p-6 sm:p-8 md:p-12 lg:p-16 rounded-hero backdrop-blur-3xl bg-white/[0.05] border border-white/10 mb-8 shadow-4xl animate-in fade-in zoom-in duration-1000">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/70 max-w-4xl mx-auto mb-10 sm:mb-14 leading-relaxed font-light">
              We empower visionary founders by transforming complex{" "}
              <span className="text-white font-bold opacity-90">Ideas</span>{" "}
              into secure, market-ready digital assets.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
              ...
              <Link href="/portfolio">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white/10 bg-transparent text-white/60 hover:bg-brand-secondary/10 hover:border-brand-secondary/30 hover:text-brand-secondary px-6 py-4 sm:px-8 sm:py-6 md:px-10 md:py-8 rounded-2xl text-base sm:text-lg md:text-xl font-black transition-all uppercase tracking-widest"
                >
                  Our Case Studies
                </Button>
              </Link>
      ...
      <section className="relative z-10 py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter uppercase leading-none">
                The Lithium <br />
                <span className="text-brand-primary">Edge</span>
              </h2>
              <p className="text-xl text-white/70 mb-10 leading-relaxed font-light">
                Lithium Labs was founded to bridge the critical gap between
                visionary concepts and production-grade digital assets.
              </p>
              <div className="space-y-6 mb-12">
                {[
                  ...
                  >
                    ...
                    <span className="text-lg font-bold tracking-tight uppercase tracking-widest text-sm opacity-100">
                      {item}
                    </span>
                  </div>
                ))}
              ...
              <Link href="/about">
                <Button
                  variant="outline"
                  className="border-white/10 bg-transparent text-white/60 hover:bg-brand-secondary/10 hover:border-brand-secondary/30 hover:text-brand-secondary px-8 py-6 rounded-xl font-black uppercase text-xs tracking-widest transition-all"
                >
                  Read Full Story
                </Button>
              </Link>
            ...
            <div className="relative h-[400px] rounded-card-md overflow-hidden border border-white/10 shadow-4xl group">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-white/10 font-black tracking-[1em] uppercase text-2xl -rotate-12 select-none">
                  Institutional
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-12">
            <div className="max-w-3xl">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-6 tracking-tighter uppercase">
                Engineering <span className="text-brand-primary">Pillars</span>
              </h2>
              <p className="text-lg text-white/70 font-light leading-relaxed">
                Strategic technical execution across the entire Software
                development lifecycle, from architectural design to
            ...
            <Link href="/services">
              <Button
                variant="link"
                className="text-brand-primary hover:text-brand-secondary text-sm font-black p-0 flex items-center group uppercase tracking-widest transition-colors"
              >
            ...
            {[
              {
                ...
                color: "brand-primary",
                description:
                  "Modern frameworks for market-ready web applications.",
              },
              {
              ...
              },
              {
                ...
                description: "Scalable institutional architectures.",
              },
              {
                icon: <Cog className="h-10 w-10" />,
                title: "API Development",
                color: "brand-primary",
                description: "Secure & Scalable platform APIS",
              },
            ].map((service, index) => (
              <Card
                key={index}
              ...
              >
                <CardContent className="p-10">
                  <div
                    className={`text-${service.color} mb-8 transition-transform group-hover:scale-110`}
                  >
                    {service.icon}
                  </div>
      ...
      <section className="relative z-10 py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-6 tracking-tighter uppercase">
              Verified <span className="text-brand-secondary">Builds</span>
            </h2>
            <p className="text-lg text-white/70 max-w-2xl mx-auto font-light mb-12">
              Showcasing selected deployments for institutional partners and
              visionary startups.
            </p>
          </div>
            ...
            {[
              {
                ...
                color: "brand-primary",
                description:
                  "Digital Creatives platform using modern incentives & rewarding mechanisms. ",
              },
              {
          ...
          <div className="text-center">
            <Link href="/portfolio">
              <Button className="bg-white/5 hover:bg-brand-secondary/10 text-white/70 hover:text-brand-secondary border border-white/10 hover:border-brand-secondary/30 px-12 py-8 rounded-2xl font-black uppercase text-sm tracking-widest shadow-2xl transition-all">
