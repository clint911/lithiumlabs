...
const project = {
  ...
  technologies: [
    { name: "NestJS", usage: "Ultra-high performance trading engine" },
    { name: "Typescript", usage: "Risk-grading algorithms and ML models" },
    { name: "PostgreSQL", usage: "ETF data warehouse with TimescaleDB" },
    { name: "Apache Kafka", usage: "Real-time data streaming" },
    { name: "React & NextJs", usage: "Investment dashboard" },
    ...
    <div className="min-h-screen bg-brand-foundation relative overflow-hidden text-white font-sans">
      ...
      <section className="relative z-10 py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          <div className="backdrop-blur-3xl bg-white/[0.03] border border-white/10 rounded-hero p-16 md:p-24 shadow-4xl">
