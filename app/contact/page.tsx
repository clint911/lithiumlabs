        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-block p-12 md:p-16 rounded-[4rem] backdrop-blur-3xl bg-white/[0.06] border border-white/10 mb-12 shadow-4xl animate-in fade-in zoom-in duration-1000">
            <h1 className="text-6xl md:text-8xl font-black text-white mb-8 tracking-tighter leading-[0.9] uppercase">
              Initiate <span className="text-brand-primary bg-clip-text text-transparent bg-gradient-to-r from-brand-primary to-brand-secondary">Strategic</span> Build
            </h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-1 space-y-10">
              <div className="p-12 rounded-[3.5rem] backdrop-blur-3xl bg-white/[0.05] border border-white/10 shadow-2xl">
                ...
                <div className="space-y-12">
                  <div className="flex items-start space-x-6 group">
                    ...
                    <div>
                      ...
                      <div className="text-white/50 text-xs font-light mt-1 tracking-wide">clintonfreelance380@gmail.com</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-6 group">
                    ...
                    <div>
                      ...
                      <div className="text-white/50 text-xs font-light mt-1 tracking-wide uppercase">Nairobi, Kenya</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-4">
                    {[Github, Linkedin, Twitter].map((Icon, idx) => (
                      <Button
                        key={idx}
                        variant="outline"
                        className="w-12 h-12 rounded-xl border-white/10 text-white/40 hover:text-white hover:bg-white/5 bg-transparent p-0 transition-all"
                      >
              ...
              <Card className="backdrop-blur-3xl bg-brand-primary/5 border-white/10 rounded-[3rem] overflow-hidden">
                <CardContent className="p-12 relative">
                  ...
                  <div className="space-y-4 relative z-10">
                    <div className="flex items-center text-xs text-white/40 font-black uppercase tracking-[0.1em]">
            ...
            <div className="lg:col-span-2">
              <Card className="backdrop-blur-3xl bg-white/[0.04] border border-white/10 rounded-[4rem] shadow-5xl relative overflow-hidden h-full">
                <CardContent className="p-12 md:p-16">
                  <h2 className="text-4xl font-black text-white mb-10 tracking-tighter uppercase">Technical Brief</h2>

                  <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      <label className="text-[9px] font-black text-white/30 uppercase tracking-[0.4em] ml-2">First Name</label>
                      <input
                        type="text"
                        required
                        className="w-full p-6 rounded-2xl backdrop-blur-3xl bg-white/[0.03] border border-white/10 text-white placeholder-white/10 focus:outline-none focus:ring-1 focus:ring-brand-primary/50 transition-all font-light text-lg"
                        placeholder="John"
                      />
                    </div>
                    <div className="space-y-3">
                      <label className="text-[9px] font-black text-white/30 uppercase tracking-[0.4em] ml-2">Last Name</label>
                      <input
                        type="text"
                        required
                        className="w-full p-6 rounded-2xl backdrop-blur-3xl bg-white/[0.03] border border-white/10 text-white placeholder-white/10 focus:outline-none focus:ring-1 focus:ring-brand-primary/50 transition-all font-light text-lg"
                    ...
                    <div className="md:col-span-2 space-y-3">
                      <label className="text-[9px] font-black text-white/30 uppercase tracking-[0.4em] ml-2">Institutional Email</label>
                      <input
                        type="email"
                        required
                        className="w-full p-6 rounded-2xl backdrop-blur-3xl bg-white/[0.03] border border-white/10 text-white placeholder-white/10 focus:outline-none focus:ring-1 focus:ring-brand-primary/50 transition-all font-light text-lg"
                    ...
                    <div className="md:col-span-2 space-y-3">
                      <label className="text-[9px] font-black text-white/30 uppercase tracking-[0.4em] ml-2">Build Domain</label>
                      <select
                        required
                    ...
                    <div className="md:col-span-2 space-y-3">
                      <label className="text-[9px] font-black text-white/30 uppercase tracking-[0.4em] ml-2">Strategic Vision</label>
                      <textarea
                        rows={5}
                        required
                        placeholder="Outline technical depth and target outcomes..."
                        className="w-full p-8 rounded-[2.5rem] backdrop-blur-3xl bg-white/[0.03] border border-white/10 text-white placeholder-white/10 focus:outline-none focus:ring-1 focus:ring-brand-primary/50 transition-all resize-none font-light leading-relaxed text-lg"
                      ></textarea>
                    </div>
